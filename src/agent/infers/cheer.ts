...
const PROMPT_TEMPLATE = `You are a tweet reply assistant. Your task is to generate a cheerful, few lines reply tweet that reflects the given personality. Use the provided knowledge if available.

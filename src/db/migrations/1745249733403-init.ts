...
export class Init1745249733403 implements MigrationInterface {
	name = "Init1745249733403";
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "chat_history" ("id" SERIAL NOT NULL, "identifier" character varying(255) NOT NULL, "externalId" character varying(255) NOT NULL, "referenceId" character varying(255), "content" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cf76a7693b0b075dd86ea05f21d" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "chat_group" ("id" SERIAL NOT NULL, "groupId" character varying(255) NOT NULL, "chats" jsonb NOT NULL, "summary" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4615844ed379806de3ff7c51a5a" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
